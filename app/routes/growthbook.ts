...
const GrowthBookExampleController = () => import('#controllers/growthbook_example_controller')
...
router
  .group(() => {
    ...
    // 管理功能
    router.get('/admin/refresh', [GrowthBookExampleController, 'refreshFeatures'])
  })
  .prefix('/api/growthbook')
  // 为所有路由应用 GrowthBook 中间件
  .use(middleware.growthbook())
